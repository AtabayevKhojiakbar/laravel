            ...
            <div class="col-md-8 col-md-offset-2 col-xs-12">
                <div class="mainheading">
                    ...
                    <div class="row post-top-meta">
                        <div class="col-md-2">
                            <a href="{{route('authors',$users->user_id)}}"><img class="author-thumb" src="https://www.gravatar.com/avatar/e56154546cf4be74e393c62d1ae9f9d4?s=250&amp;d=mm&amp;r=x" alt="Sal"></a>
                        </div>
                        <div class="col-md-10">
                            <a class="link-dark" href="{{route('authors',$users->user_id)}}">{{$users->avtor->name}}</a><a href="#" class="btn follow">Follow</a>
                            ...
                            <span class="post-date">{{$users->updated_at}}</span><span class="dot"></span><span class="post-read">6 min read</span>
                        </div>
                    </div>
                    <!-- End Top Menta -->

                    <h1 class="posttitle">{{$users->title}}</h1>

                </div>

                <!-- Begin Featured Image -->
                <img class="featured-image img-fluid" src='{{asset("/posts/images/$users->img")}}' alt="rasm">
                <!-- End Featured Image -->
                ...
                <div class="col-md-4">
                    <div class="card">
                        <a href="{{route('single',$post->id)}}">
                            <img class="img-fluid img-thumb" src='{{asset("/posts/images/$post->img")}}' alt="">
                        </a>
